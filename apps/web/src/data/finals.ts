...
export const FINAL_SEVEN_DATA: FinalData[] = [
  ...
  },
  {
    ...
    results: [
      ...
      { position: 7, name: 'Sherley', playerKey: 'sherley' },
      { position: 8, name: 'Halcón', playerKey: 'halcon' },
    ],
  },
  {
    ...
    results: [
      ...
      { position: 8, name: 'Rasta', playerKey: 'rasta' },
    ],
  },
  {
    ...
    results: [
      ...
      { position: 8, name: 'Santini', playerKey: 'santi' },
    ],
  },
  {
    ...
    results: [
      { position: 1, name: 'Gabo', playerKey: 'gabo' },
      { position: 2, name: 'Halcón', playerKey: 'halcon' },
      { position: 3, name: 'Mich', playerKey: 'mich' },
      { position: 4, name: 'Ari', playerKey: 'ari' },
      { position: 5, name: 'Gonzalo', playerKey: 'gonzalo' },
      { position: 6, name: 'Araña', playerKey: 'arana' },
      { position: 7, name: 'Rasta', playerKey: 'rasta' },
      { position: 8, name: 'Lucas', playerKey: 'lucas' },
    ],
  },
  {
    ...
    results: [
      ...
      { position: 7, name: 'Halcón', playerKey: 'halcon' },
      { position: 8, name: 'Sherley', playerKey: 'sherley' },
    ],
  },
  {
    ...
    results: [
      ...
      { position: 6, name: 'Gonzalo', playerKey: 'gonzalo' },
      { position: 7, name: 'FFF', playerKey: 'fff' },
      { position: 8, name: 'Guille', playerKey: 'guille' },
    ],
  },
  {
  ...
  },
  {
    ...
    results: [
      ...
      { position: 5, name: 'Mich', playerKey: 'mich' },
      { position: 6, name: 'Araña', playerKey: 'arana' },
      { position: 7, name: 'Gonzalo', playerKey: 'gonzalo' },
    ],
  },
  {
    ...
    results: [
      ...
      { position: 8, name: 'Toti', playerKey: 'toti' },
    ],
  },
  {
    ...
    results: [
      { position: 1, name: 'Gabo', playerKey: 'gabo' },
      { position: 2, name: 'Mich', playerKey: 'mich' },
      { position: 3, name: 'FFF', playerKey: 'fff' },
      { position: 4, name: 'Halcón', playerKey: 'halcon' },
      { position: 5, name: 'Araña', playerKey: 'arana' },
      { position: 6, name: 'Toti', playerKey: 'toti' },
      { position: 7, name: 'Ari', playerKey: 'ari' },
    ],
  },
  {
    ...
    results: [
      { position: 1, name: 'Ari', playerKey: 'ari' },
      { position: 2, name: 'Gabo', playerKey: 'gabo' },
      { position: 3, name: 'Halcón', playerKey: 'halcon' },
      { position: 4, name: 'Tala', playerKey: 'tala' },
      { position: 5, name: 'FFF', playerKey: 'fff' },
      { position: 6, name: 'Shark', playerKey: 'shark' },
